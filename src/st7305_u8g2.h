// ST7305 300x400 RLCD driver wrapped as a U8g2 backend.
// Adapted from Waveshare's reference driver for ESP32-S3-RLCD-4.2.
#pragma once
...
public:
  ...
  // tile_buf_height 0 means full-buffer (~15 KB for 300x400).
