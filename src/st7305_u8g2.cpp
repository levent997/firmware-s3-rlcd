// Adapted from Waveshare's ST7305_U8g2 reference. Init sequence is unchanged.
...
ST7305_U8g2::~ST7305_U8g2() {
  ...
  if (g_lcd_instance == this) g_lcd_instance = nullptr;
}
...
void ST7305_U8g2::begin(uint8_t tile_buf_height, const u8g2_cb_t *rotation) {
  ...
  if (tbh > ST7305_TILE_HEIGHT) tbh = ST7305_TILE_HEIGHT;
